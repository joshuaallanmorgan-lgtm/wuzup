...
- Flags (defaults applied per contract, override any time): ⚑U-WB migrate WB to a view (default: yes) · ⚑U-GRID month-cell channel (default: week-strip carries state) · ⚑U-V7 violet #7 (default: sanctioned, every conversion one-shot/day) · ⚑U-INV share-only invites (default: ratified) · ⚑U-REST rest-day copy (Charles) · ⚑U-HZN planning horizon (default: full supply window, forecast caveat past day 16) · ⚑U-WKND weekend pill fate (default: becomes "this weekend" shortcut).
